...
def test_get_student_with_more_classes():
    ...
    compare = get_student_with_more_classes(ada, charles)
    compare_2 = get_student_with_more_classes(charles, ada)

    assert compare == ada
    assert compare_2 == ada
